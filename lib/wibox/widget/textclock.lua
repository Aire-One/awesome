...
--- Text clock widget.
--
-- The `wibox.widget.textclock` widget is part of the Awesome WM's wiboxes
-- system (see @{03-declarative-layout.md}).
--
-- This widget displays a text clock formated by the
...
--
-- You can read more on the GLib DateTime format at
-- [https://developer.gnome.org/glib/stable/glib-GDateTime.html#g-date-time-format](https://developer.gnome.org/glib/stable/glib-GDateTime.html#g-date-time-format).
--
